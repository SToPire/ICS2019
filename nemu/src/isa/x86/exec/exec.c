...
/* 0x80, 0x81, 0x83 */
make_group(gp1, EX(add), EX(or), EMPTY, EX(sbb), EX(and), EX(sub), EX (xor), EX(cmp))

    /* 0xc0, 0xc1, 0xd0, 0xd1, 0xd2, 0xd3 */
    make_group(gp2, EX(rol), EMPTY, EMPTY, EMPTY, EX(shl), EX(shr), EMPTY, EX(sar))
    ...
    static OpcodeEntry opcode_table[512] = {
        ...
        /* 0x68 */ IDEXW(push_SI, push, 4), IDEX(I_E2G, imul3), IDEXW(push_SI, push, 1), EMPTY,
        ...
        /* 0x20 */ IDEX(mov_G2E, mov_spe2reg), EMPTY, IDEX(mov_E2G, mov_reg2spe), EMPTY,
