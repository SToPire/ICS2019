...
/* 0x80, 0x81, 0x83 */
make_group(gp1, EX(add), EMPTY, EMPTY, EMPTY, EX(and), EX(sub), EMPTY, EX(cmp))
    ...
    static OpcodeEntry opcode_table[512] = {
        ...
        /* 0x68 */ IDEXW(push_SI, push, 4), EMPTY, IDEXW(push_SI, push, 1),
        EMPTY,
        ...
        /* 0xe4 */ IDEXW(I2a, in, 1), IDEX(I2a, in), IDEXW(I2a, out, 1),
        IDEX(I2a, out),
        ...
        /* 0x94 */ IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), EMPTY,
        EMPTY,
